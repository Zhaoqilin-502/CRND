...
class Explorer:
    ...
    def create_embeddings_table(self, force: bool = False, split: str = "train") -> None:
        ...
        Example:
            ```python
            exp_yolo11wuyuquanzhong = Explorer()
            exp_yolo11wuyuquanzhong.create_embeddings_table()
            ```
        """
    ...
    def query(
        ...
        Example:
            ...
            exp_yolo11wuyuquanzhong = Explorer()
            exp_yolo11wuyuquanzhong.create_embeddings_table()
            similar = exp_yolo11wuyuquanzhong.query(img="https://ultralytics.com/images/zidane.jpg")
            ```
        """
    ...
    def sql_query(
        ...
        Example:
            ...
            result = exp_yolo11wuyuquanzhong.sql_query(query)
            ```
        """
    ...
    def plot_sql_query(self, query: str, labels: bool = True) -> Image.Image:
        ...
        Example:
            ...
            exp_yolo11wuyuquanzhong.create_embeddings_table()
            query = "SELECT * FROM 'table' WHERE labels LIKE '%person%'"
            result = exp_yolo11wuyuquanzhong.plot_sql_query(query)
            ```
        """
    ...
    def get_similar(
        ...
        Example:
            ...
            exp_yolo11wuyuquanzhong = Explorer()
            exp_yolo11wuyuquanzhong.create_embeddings_table()
            similar = exp_yolo11wuyuquanzhong.get_similar(img="https://ultralytics.com/images/zidane.jpg")
            ```
        """
    ...
    def plot_similar(
        ...
        Example:
            ...
            exp_yolo11wuyuquanzhong = Explorer()
            exp_yolo11wuyuquanzhong.create_embeddings_table()
            similar = exp_yolo11wuyuquanzhong.plot_similar(img="https://ultralytics.com/images/zidane.jpg")
            ```
        """
    ...
    def similarity_index(self, max_dist: float = 0.2, top_k: float = None, force: bool = False) -> Any:  # pd.DataFrame
        ...
        Example:
            ...
            exp_yolo11wuyuquanzhong = Explorer()
            exp_yolo11wuyuquanzhong.create_embeddings_table()
            sim_idx = exp_yolo11wuyuquanzhong.similarity_index()
            ```
        """
        if self.table is None:
            raise ValueError("Table is not created. Please create the table first.")
    ...
    def plot_similarity_index(self, max_dist: float = 0.2, top_k: float = None, force: bool = False) -> Image:
        ...
        Example:
            ...
            similarity_idx_plot = exp_yolo11wuyuquanzhong.plot_similarity_index()
    ...
    def ask_ai(self, query):
        ...
        Example:
            ...
            exp_yolo11wuyuquanzhong = Explorer()
            exp_yolo11wuyuquanzhong.create_embeddings_table()
            answer = exp_yolo11wuyuquanzhong.ask_ai("Show images with 1 person and 2 dogs")
            ```
        """
